public class YahtzeeScore {
    ...
    static void runTestcase(int __case) {
        ...
        case -1:
            // doTest(toss, expected, __case);
            break;

        case 0: {
            int toss[] = new int[] { 2, 2, 3, 5, 4 };
            int __excepted = 5;
            doTest(toss, __excepted, __case);
            break;
        }
        case 1: {
    ...
    static void doTest(int[] toss, int __expected, int caseNo) {
    ...
    public static void main(String[] args) {
        ...
        int T = (int) (System.currentTimeMillis() / 1000) - 1371157902;
